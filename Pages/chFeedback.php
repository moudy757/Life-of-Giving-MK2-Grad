...
<section class="wrapper">
    ...
    <div class="grid feedback">
        <div class="">
            <form id="chFeedback" class="input-group card" action="../Includes/feedback.inc.php" method="post">
                <div class="darkBorder">
                    ...
                    <div class="input-div text-center">
                        <textarea name="chFeedback" id="" cols="50" rows="5" maxlength='255' required></textarea>
                    </div>
                    <button type="submit" name="chFeedbackSubmit" class="submit-btn md">Submit</button>
                </div>
            </form>
        </div>

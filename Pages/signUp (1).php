            ...
            <form action="../Includes/hsSignUp.inc.php" method="post" id="signupHs" class="input-group card">
                ...
                <div class="darkBorder">
                    <div class="input-div text-center">
                        <input type="text" class="input-field text-center" name="hsFirstName" placeholder="الاسم الاول" pattern="[A-Za-z]{3,}" title="Must not contain numbers" />
                        <input type="text" class="input-field text-center" name="hsLastName" placeholder="الاسم الاخير"
                            pattern="[A-Za-z]{3,}" title="Must not contain numbers" />
                        <input type="text" class="input-field text-center" name="hsUserName" placeholder="اسم المستخدم"
                            pattern="[A-Za-z0-9]{5,}" />
                        ...
                        <div class="custom-select">
                            <select name="children" id="" class="select">
                                <option disabled selected>عدد الاطفال</option>
                            ...
                            <select name="wives" id="" class="select">
                                <option disabled selected>عدد الازواج</option>
                                <option value="none">0</option>
                                <option value="1">1</option>
                                <option value="2">2</option>
                                <option value="3">3</option>
                        ...
                        <input type="number" onkeypress='validate(event)' class="input-field text-center"
                            name="nationalID" placeholder="الرقم القومي" />
                        <input type="password" class="input-field text-center" name="hsPwd" placeholder="كلمة السر"
                            pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}"
                            title="Must contain at least one  number and one uppercase and lowercase letter, and at least 6 or more characters" />
                        <input type="password" class="input-field text-center" name="hsPwdRepeat" placeholder="تأكيد كلمة السر"
                            minlength="5" maxlength="10" />
                        <!-- <input type="number" onkeypress='validate(event)' class="input-field text-center" name="hsAge"
                            placeholder="Age" /> -->
                        <label class="age-label" for="Age">ت.م</label>
                        <input type="date" value="Age" class="input-field text-center age-input" name="hsAge"
                            placeholder="ت.م" />
                        <input type="text" class="input-field text-center" name="hsJob" placeholder="المهنة" />
                        ...
                        <div class="text-center input-div">
                            ...
                            <label for="gender-male">ذكر</label>
                            <input type="radio" id="gender-female" name="hsGender" value="F" />
                            <label for="gender-female">أنثى</label>
                        </div>
                        <div class="custom-select">
                            <select name="hsIncome" id="" class="select">
                                <option disabled selected>الدخل الشهري</option>
                    ...
                    <div class="input-div text-center">
                        ...
                        <input type="text" class="input-field text-center" name="hsDistrict" placeholder="الحي" />
                        <input type="text" class="input-field text-center" name="hsStreet" placeholder="الشارع" />
                    </div>
                    <div class="text-center">
                        <input type="text" class="input-field text-center" name="hsHealthStatus"
                            placeholder="الحالة الصحية (أختياري)" />
                        <br>
                        <label for="hsHealthUpload">.تحميل الوثائق ذات صلة هنا</label>
                        <input type="file" accept="image/jpeg,image/gif,image/png,application/pdf,image/x=eps"
                            class="file" name="hsHealthUpload" />
                    </div>
                    <div class="input-div">
                        <p class="text-center">وصف الحالة</p>
                        <textarea name="caseDescription" id="" cols="30" rows="10"></textarea>
                    </div>

                    <button type="submit" name="hsSignupSubmit" class="submit-btn md">الاشتراك</button>
                </div>
            </form>
                ...
                <div class="darkBorder">
                    <div class="input-div text-center">
                        <input type="text" class="input-field text-center" name="chName" placeholder="Charity Name"
                            minlength="5" maxlength="15" pattern="[A-Za-z]{5,}" title="Must not contain numbers" />
                        <input type="text" class="input-field text-center" name="chUserName" placeholder="UserName"
                            minlength="5" maxlength="15" pattern="[A-Za-z0-9]{5,}" />
                ...
                <div class="darkBorder">
                    <div class="input-div">
                        <input type="text" class="input-field text-center" name="dFirstName" placeholder="Frist Name"
                            minlength="3" maxlength="10" pattern="[A-Za-z]{3,}" title="Must not contain numbers" />
                        ...
                        <input type="text" class="input-field text-center" name="dUserName" placeholder="UserName"
                            minlength="5" maxlength="10" pattern="[A-Za-z0-9]{5,}" />
